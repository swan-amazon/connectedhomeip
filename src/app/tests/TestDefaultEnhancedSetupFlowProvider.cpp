...
public:
    ...
    CHIP_ERROR CommitAcceptance() override { return CHIP_NO_ERROR; }
    ...
    CHIP_ERROR ResetAcceptance() override { return CHIP_NO_ERROR; }
...
TEST(DefaultEnhancedSetupFlowProvider, TestRevertAcceptanceRetainsRequirements)
{
    CHIP_ERROR err;
    ...
    err = esfProvider.RevertTermsAndConditionsAcceptance();
    EXPECT_EQ(CHIP_NO_ERROR, err);
