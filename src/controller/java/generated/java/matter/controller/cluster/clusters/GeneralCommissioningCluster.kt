...
class GeneralCommissioningCluster(
  ...
  class SetTCAcknowledgementsResponse(val errorCode: UByte, val debugText: String)
  ...
  suspend fun setTCAcknowledgements(
    ...
    return SetTCAcknowledgementsResponse(errorCode_decoded, debugText_decoded)
  }
  ...
  suspend fun writeTCAcknowledgementsAttribute(value: UShort, timedWriteTimeout: Duration? = null) {
    val ATTRIBUTE_ID: UInt = 7u
